...
public static class Constants
{
    ...
    [ 
        new Item("Huey's Love Letter", "hueyletter", 0x01),
        new Item("Jigsaw", "jigsaw", 0x02),
        new Item("ID Card (P)", "", 0x03),
        new Item("EZ Gun (LR) Spec", "", 0x04),
        new Item("EZ Gun (PR) Spec", "", 0x05),
        new Item("PM Spec", "", 0x06),
        new Item("PB/6P9 Spec", "", 0x07),
        new Item("M1911A1 Spec", "", 0x08),
        new Item("M1911A1 Custom Spec", "", 0x09),
        new Item("C96 Spec", "", 0x0A),
        new Item("M19 Spec", "", 0x0B),
        new Item("Kampfpistole Spec", "", 0x0C),
        new Item("Support Supply Marker Spec", "", 0x0D),
        new Item("Support Strike Marker Spec", "", 0x0E),
        new Item("Banana Cultivation Instructions", "", 0x0F),
        new Item("Twin Barrel Shotgun Spec", "", 0x10),
        new Item("Twin Barrel (Rubber Slug) Spec", "", 0x11),
        new Item("M37 Spec", "", 0x12),
        new Item("SPAS-12 Spec", "", 0x13),
        new Item("CAW Spec", "", 0x14),
        new Item("M16A1(STG) Spec", "", 0x15),
        new Item("M16A1(STG + Laser) Spec", "", 0x16),
        new Item("Patriot Spec", "", 0x17),
        new Item("M16A1(GL) Spec", "", 0x18),
        new Item("M16A1(GL + Laser) Spec", "", 0x19),
        new Item("M16A1(SGL) Spec", "", 0x1A),
        new Item("M16A1(SGL + Laser) Spec", "", 0x1B),
        new Item("M653 Spec", "", 0x1C),
        new Item("M653(GL) Spec", "", 0x1D),
        new Item("M653(STG) Spec", "", 0x1E),
        new Item("M653(SGL) Spec", "", 0x1F),
        new Item("RK47 Spec", "", 0x20),
        new Item("RK47(GL) Spec", "", 0x21),
        new Item("ADM63 Spec", "", 0x22),
        new Item("ADM65 Spec", "", 0x23),
        new Item("RK47(SGL) Spec", "", 0x24),
        new Item("RPK Spec", "", 0x25),
        new Item("FAL Spec", "", 0x26),
        new Item("SUG Spec", "", 0x27),
        new Item("G11 Spec", "", 0x28),
        new Item("Tanegashima Musket Spec", "", 0x29),
        new Item("M10 Spec", "", 0x2A),
        new Item("M10 (BJ) Spec", "", 0x2B),
        new Item("UZ61 Spec", "", 0x2C),
        new Item("MP5A2 Spec", "", 0x2D),
        new Item("MP5SD2 Spec", "", 0x2E),
        new Item("M1928A1 Spec", "", 0x2F),
        new Item("M1C Spec", "", 0x30),
        new Item("M1C (PR) Spec", "", 0x31),
        new Item("M21 Spec", "", 0x32),
        new Item("M700 Spec", "", 0x33),
        new Item("M700 (LR) Spec", "", 0x34),
        new Item("Mosin-Nagant Spec", "", 0x35),
        new Item("SVD Spec", "", 0x36),
        new Item("SVD(NV) Spec", "", 0x37),
        new Item("WA2000 Spec", "", 0x38),
        new Item("PTRD1941 Spec", "", 0x39),
        new Item("PTRS1941 Spec", "", 0x3A),
        new Item("Stealth Gun Spec", "", 0x3B),
        new Item("Railgun Spec", "", 0x3C),
        new Item("M60 Spec", "", 0x3D),
        new Item("M60 (Armor Piercing) Spec", "", 0x3E),
        new Item("M63A1 Spec", "", 0x3F),
        new Item("PKM Spec", "", 0x40),
        new Item("MG3 Spec", "", 0x41),
        new Item("MG3 (Armor Piercing) Spec", "", 0x42),
        new Item("M134 Spec", "", 0x43),
        new Item("EM Wave Spec", "", 0x44),
        new Item("LAW Spec", "", 0x45),
        new Item("M202A1 Spec", "", 0x46),
        new Item("M202A1 Spec", "", 0x47),
        new Item("RPG-2 Spec", "", 0x48),
        new Item("RPG-7 Spec", "", 0x49),
        new Item("FIM-43 Spec", "", 0x4A),
        new Item("XFIM-92A Spec", "", 0x4B),
        new Item("Carl Gustav M2 Spec", "", 0x4C),
        new Item("Carl Gustav (MP) Spec", "", 0x4D),
        new Item("Carl Gustav (Fulton) Spec", "", 0x4E),
        new Item("M47 Spec", "", 0x4F),
        new Item("Human Slingshot Spec", "", 0x50),
        new Item("Stun Grenade Spec", "", 0x51),
        new Item("Smoke Grenade Spec", "", 0x52),
        new Item("Chaff Grenade Spec", "", 0x53),
        new Item("Smoke Grenade (Colored) Spec", "", 0x54),
        new Item("Support Supply Marker (Thrown) Spec", "", 0x55),
        new Item("Support Strike Marker (Thrown) Spec", "", 0x56),
        new Item("Electromagnetic Net Spec", "", 0x57),
        new Item("Sleep Gas Grenade Spec", "", 0x58),
        new Item("C4 Spec", "", 0x59),
        new Item("Claymore Spec", "", 0x5A),
        new Item("Magazine Spec", "", 0x5B),
        new Item("Hobby Magazine Spec", "", 0x5C),
        new Item("Hobby Magazine Spec", "", 0x5D),
        new Item("Hobby Magazine Spec", "", 0x5E),
        new Item("Hobby Magazine Spec", "", 0x5F),
        new Item("Anti-tank Mine Spec", "", 0x60),
        new Item("Decoy Design Spec", "", 0x61),
        new Item("Aerial Mine Spec", "", 0x62),
        new Item("Fulton Sleep Gas Mine Spec", "", 0x63),
        new Item("Cookbook Research Notes", "", 0x64),
        new Item("Support Strike Mk. (Set) Spec", "", 0x65),
        new Item("Support Strike Mk. (Set) Spec", "", 0x66),
        new Item("Curry Recipe Spec", "", 0x67),
        new Item("Stealth Mat Spec", "", 0x68),
        new Item("Stealth Camouflage Spec", "", 0x69),
        new Item("Love Box Spec", "", 0x6A),
        new Item("Cardboard Box Tank Spec", "", 0x6B),
        new Item("Night Vision Goggles Spec", "", 0x6C),
        new Item("Ballisitic Shield Spec", "", 0x6D),
        new Item("Ballistic Shield (Color) Spec", "", 0x6E),
        new Item("Infinity Bandana Spec", "", 0x6F),
        new Item("Soliton Radar Design Spec", "", 0x70),
        new Item("Sonic Eye Design Spec", "", 0x71),
        new Item("Canned Soft Drink Recipe", "", 0x72),
        new Item("Tortilla Chips Recipe", "", 0x73),
        new Item("Box Bomb Spec", "", 0x74),
        new Item("Stun Box Spec", "", 0x75),
        new Item("Smoke Box Spec", "", 0x76),
        new Item("??? Spec", "", 0x77),
        new Item("Assassin's Straw Box Spec", "", 0x78),
        new Item("Rescue Box Spec", "", 0x79),
        new Item("Rare-meat Ration Spec", "", 0x7A),
        new Item("Well-done Ration Spec", "", 0x7B),
        new Item("Burnt Ration Spec", "", 0x7C),
        new Item("Cologne", "", 0x7D),
        new Item("Rath Wing", "", 0x7E),
        new Item("Tigrex Fang", "", 0x7F),
        new Item("Gear Rex Mucous", "", 0x80),
        new Item("Gear Rex Concentrate", "", 0x81),
        new Item("Gear Rex Super Extract", "", 0x82),
    ];
